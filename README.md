# wanted-pre-onboarding-challenge-fe-1 사전과제

## 주제

제공받은 [backend API repo](https://github.com/starkoora/wanted-pre-onboarding-challenge-fe-1-api)로 **로그인 / 회원가입 기능**이 포함된 **Todo App** 제작

## 기간

2022.12.22 (목) - 2023.1.5 (목)

## 기술 스택

- React + typescript
- recoil(시간이 된다면 SWR 적용)
- (스타일 미정)
